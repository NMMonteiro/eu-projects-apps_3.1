// Debug script to see what HTML EU pages actually return (Node.js version)
...
writeFileSync('eu-page-sample.html', html);
console.log("\n✓ Full HTML saved to eu-page-sample.html");
console.log("\nOpen eu-page-sample.html to see the full structure!");
